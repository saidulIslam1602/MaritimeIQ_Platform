...
using MaritimeRoute = MaritimeIQ.Platform.Models.Route;

namespace MaritimeIQ.Platform.Data
{
    public static class MaritimeFleetData
    {
        /// <summary>
        /// Modern hybrid coastal vessels for maritime operations
        /// </summary>
        public static List<Vessel> GetMaritimeFleet()
        {

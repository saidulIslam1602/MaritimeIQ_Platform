...
- "REST API provides easy access to Kafka streaming for external systems"- "Batch publishing optimizes for high-throughput scenarios"- "Partitioning by MMSI ensures ordered processing per vessel"- "Status endpoint enables monitoring and health checks"- "Test endpoint useful for development and integration testing"**Performance Characteristics:**

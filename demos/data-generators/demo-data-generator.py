...
class MaritimeDataGenerator:
 ...
 """Initialize fleet of vessels with realistic data"""vessel_types = ['Container Ship', 'Tanker', 'Bulk Carrier', 'Cruise Ship', 'Ferry']
 norwegian_ports = [
 ...
 """Generate realistic vessel position data"""# Simulate vessel movement
 ...
 """Generate realistic engine performance data"""base_temp = 75 # Base engine temperature
 ...
 """Generate environmental monitoring data"""# Base emissions based on vessel size and speed
 ...
 """Generate weather conditions around vessel"""return {
 'VesselId': vessel['vessel_id'],
 'Latitude': round(vessel['current_lat'], 6),
 'Longitude': round(vessel['current_lon'], 6),
 ...
 """Send data to Azure Event Hub"""producer = EventHubProducerClient.from_connection_string(
 ...
 """Generate continuous maritime data for demo"""print(f"Starting Maritime Data Generator for {duration_minutes} minutes...")
...
def main():
 """Main function for demo data generation"""# These would be your actual Azure Event Hub connection details
 # For interview demo, you'll replace these with your actual values
 
 connection_string = "Endpoint=sb://your-eventhub-namespace.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=your-key"event_hub_name = "maritime-data"print("Maritime Platform - Interview Demo Data Generator ")
 print("="* 60)
